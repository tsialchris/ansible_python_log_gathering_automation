...
if True:
    ...
    for line in lines:
        ...
        network_devices_found = check_for_element("}NETWORK_DEVICES", line)

        device_found = check_for_element("}DEVICE", line)

        connections_found = check_for_element("}CONNECTIONS", line)

        interfaces_found = check_for_element("}INTERFACES", line)

        anything_found = any(network_devices_found, device_found, connections_found, interfaces_found)
